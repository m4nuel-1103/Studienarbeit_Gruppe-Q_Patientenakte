...
router.get('/documents/patient_small/:id', [DocumentsController, "forPatientNoContent"])
...
router.get('/released_documents_for_small/doctor_patient/', [ReleasedDocumentsController, "forDoctorPatientNoContent"])
